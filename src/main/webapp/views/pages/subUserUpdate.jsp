					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
										<form action="subUserUpdate.do" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="client_name" id="client_name" class="form-control " class="client_name" value="${dtl.client_name}" />
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="client_id" id="client_id" class="form-control " class="client_id" value="${dtl.client_id}" readonly="readonly"/>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="client_gender" id="client_gender" class="form-control " class="client_id" value="${dtl.client_gender}"  readonly="readonly"/>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="client_phone" id="client_phone" class="form-control " class="client_phone" value="${dtl.client_phone}" />
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="client_address" onclick="addr()" value="${dtl.client_address}" name="client_address" class="form-control "/>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="client_birth" id="client_birth" class="form-control " class="client_birth" value="${dtl.client_birth}" readonly="readonly"/>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="sub_name" id="value" class="form-control " class="value" value="${dtl.sub_name}" onclick="subSearch_popup(event)" readonly="readonly"/>
												<input type="hidden" name="sub_idx" id="sub_idx"/> 
												<button type="button" onclick="sub_use(event)">이용내역</button>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="date" name="sub_use_start" value="${dtl.sub_use_start}" class="form-control " readonly="readonly"/>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="date" name="sub_use_end" value="${dtl.sub_use_end}" class="form-control " readonly="readonly"/>
											</div>
										</div>
