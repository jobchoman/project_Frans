...
<script>
var order_send = $("#order_send").parent().parent();

/*  var test = $("#order_send").innerText; */
	...
	checkbox.each(function(i) {
		...
		$.ajax({
			...
			success : function(data) {
				...
				console.log(data);
				if(data == '성공'){
					window.location.href = "/subOrderDetail.go?order_date="+order_date+"&shop_idx="+shop_idx;
