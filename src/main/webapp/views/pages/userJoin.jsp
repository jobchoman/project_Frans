					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="userJoin.do" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="client_name" id="name" required="required" class="form-control "/>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="client_id" id="id" required="required" class="form-control "/>
											</div>
										</div>
<!-- 										<div class="item form-group"> -->
...
<!-- 										</div> -->
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="password" name="client_pw" id="pw2" required="required" class="form-control "/>
											</div>
										</div>
										...
										<div>
											...
											<div class="radio">
												<label>
													<input type="radio" value="남" id="optionsRadios1" name="client_gender" >남
												</label>
											</div>
											<div class="radio">
												<label>
													<input type="radio" value="여" id="optionsRadios2" name="client_gender">여
												</label>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="client_phone" id="phone" required="required" class="form-control ">
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="client_address" onclick="addr()" name="client_address" class="form-control "/>
