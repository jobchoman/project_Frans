              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" role="tab"  aria-selected="true" onclick="location.href='memberInfoPosList.go'">직급</a>
                      </li>
                      <li class="nav-item">
...
<!-- 							</select> -->
                    ...
                    <button type="button" class="btn btn-round btn-info" onclick="location.href='memberInfoPosWrite.go'" style="margin-left: 90%">추가</button>
